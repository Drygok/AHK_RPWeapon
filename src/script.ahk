...
global processName := "CR-MP.COM" // Имя процесса для Amazing 0.3.7 - если Вы используете скрипт в других играх, тут нужно указать заголовок процесса. Например, для SA-MP это gta_sa.exe
// Укажите "grand_theft_auto_san_andreas.dll" вместо "CR-MP.COM", чтобы использовать скрипт в CR:MP 0.3e
